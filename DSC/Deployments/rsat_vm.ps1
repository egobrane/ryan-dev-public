Configuration management_vm {
	...
	#Desc: Management VM DSC Configuration
	Node localhost {

		#Doc: Sets fDenyTSConnections registry key to 0.
		...
		#Doc: Ensures required RSAT features are installed for Domain Management.
		Script EnableRSAT
		{
			TestScript = {
		...
		#Doc: Ensures Hyper-V RSAT tools are installed for Hyper-V Management.
		...
		#Doc: Ensures IIS management features are installed.
		...
		#Doc: Ensures Windows Firewall rules for Remote Desktop are disabled.
		...
		#Doc: Ensures local Administrators group contains egobranela and Management Users role.
		Script SetLocalAdminManagementRole
		{
			TestScript = {
